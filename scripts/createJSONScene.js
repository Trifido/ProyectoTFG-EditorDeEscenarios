...
function JsonPicture(elemento){
    ...
    xmlhttp.open("GET", "./php/iniciarPuntoCuadro.php?posX=" + interpolador.getX()+ "&posY=" + objdin.alturaCuadro + "&posZ=" + interpolador.getZ() + "&rotCuadro=" +  objdin.rotCuadro, false);
    xmlhttp.send();
	...
	text += ' "alto":' +  objdin.alto + ',';
	text += ' "alturaCuadro":' +  objdin.alturaCuadro + ',';
...
function JsonSavePicture(elemento){
	...
	text += ' "largo":' +  (objdin.largo*10) + ',';
	text += ' "alto":' +  (objdin.alto*10) + ',';
	text += ' "textura": "' +  objdin.textura + '"} ';
