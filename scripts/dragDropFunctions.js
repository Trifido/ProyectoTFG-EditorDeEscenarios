...
function ObjetoValido(){
    return (DragTarget.getAttributeNS(null,'nombre') != "rotate" && DragTarget.getAttributeNS(null,'nombre') != "delete" && DragTarget.getAttributeNS(null, 'class') != "limitline"); 
};
...
function Drag(evt)
{
    ...
    if (DragTarget)
    {
        ...
        if(ObjetoValido()){
            ...
            if(DragTarget != elementoAnterior){
                menu.removeMenu();
            }
