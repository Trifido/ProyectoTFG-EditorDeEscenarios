...
function Picture(nombre, nombrebd, pathLocation, altura, anchura, altoReal, largoReal, pathEscena){
	...
	this.svgObject.setAttributeNS(null,'alturaCuadro', 0.3);
...
function LoadPictureCanvas( posX, posY, coordX, coordY, cx, cy, rotation, alturaCuadro){
	...
	targetElement.setAttributeNS(null,'alturaCuadro', alturaCuadro);
