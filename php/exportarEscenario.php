                        ...
                        <form role="form" id="EscenarioForm" method="post" action="./RegistrarSala.php" >
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="button" id="BImgEscenario" class="btn btn-primary btn-block" onclick="sendImgEscenario()" disabled>Añadir Imagen Escenario</button>
                                </div>  
                            </fieldset>
                        </form>                       
                    </div>
