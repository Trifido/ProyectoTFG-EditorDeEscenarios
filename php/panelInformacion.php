...
<script type="text/javascript">
    function loadParametrosCamara(){
        document.getElementById("alturacamara").value = document.getElementById('VRcamera_level').childNodes[0].getAttributeNS(null, 'altura');
        document.getElementById("zancadacamara").value = document.getElementById('VRcamera_level').childNodes[0].getAttributeNS(null, 'zancada');
    }
</script>
...
<div class="panel panel-primary" id="panelInfo">
    ...
    <div class="panel-body">
        ...
        <ul class="nav nav-pills" id="labels">
            ...
            <li><a href="#camara-pills" data-toggle="tab" onclick="loadParametrosCamara()">Primera Persona</a>
            </li>
        </ul>
        <!-- Tab panes -->
        ...
        <!------------------------------------ INICIO FICHA TÉCNICA ------------------------------------>
            <div class="tab-pane fade in active" id="ficha-pills">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group" id="altoCuadro">
                            <label>Altura Cuadro</label>
                            <input id="campCuadAlto" class="form-control" onkeyup="addAlturaCuadro(this.value)">
                        </div>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="tab-pane fade" id="camara-pills">
            	<div class="row">
            		<div class="col-lg-12">
                        ...
                        <div class="form-group">
                            <label>Altura</label>
                            <input id="alturacamara" value="" class="form-control" onkeyup="addAlturaCamaraFP(value)">
                        </div>
                        <div class="form-group">
                            <label>Zancada</label>
                            <input id="zancadacamara" value="" class="form-control" onkeyup="addZancadaCamaraFP(value)">
                        </div>
					</div>
				</div>
            </div>
